...
const mostBlogs = (blogs) => {
    ...
    authors.forEach(author => blogsPerAuthor.push({ author: author, blogs: blogs.filter(obj => obj.author === author).length }))
...
const mostLikes = (blogs) => {
    ...
    authors.forEach(author => likesPerAuthor.push({ author: author, likes: blogs.filter(blog => blog.author === author).map(blog => blog.likes).reduce(reducer, 0) }))
